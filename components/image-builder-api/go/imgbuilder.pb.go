...
type BuildInfo struct {
	...
	LogUrlExtraHeaders map[string]string `protobuf:"bytes,7,rep,name=log_url_extra_headers,json=logUrlExtraHeaders,proto3" json:"log_url_extra_headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *BuildInfo) GetLogUrlExtraHeaders() map[string]string {
	if x != nil {
		return x.LogUrlExtraHeaders
	}
	return nil
}
...
var file_imgbuilder_proto_rawDesc = []byte{
	...
	0x06, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x73, 0x22, 0xdf, 0x02, 0x0a, 0x09, 0x42, 0x75, 0x69, 0x6c,
	...
	,
...
var file_imgbuilder_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_imgbuilder_proto_goTypes = []interface{}{
	...
	nil,                                   // 18: builder.BuildInfo.LogUrlExtraHeadersEntry
	(*api.WorkspaceInitializer)(nil),      // 19: contentservice.WorkspaceInitializer
}
var file_imgbuilder_proto_depIdxs = []int32{
	...
	19, // 2: builder.BuildSourceDockerfile.source:type_name -> contentservice.WorkspaceInitializer
	...
	18, // 15: builder.BuildInfo.log_url_extra_headers:type_name -> builder.BuildInfo.LogUrlExtraHeadersEntry
	4,  // 16: builder.ImageBuilder.ResolveBaseImage:input_type -> builder.ResolveBaseImageRequest
	6,  // 17: builder.ImageBuilder.ResolveWorkspaceImage:input_type -> builder.ResolveWorkspaceImageRequest
	8,  // 18: builder.ImageBuilder.Build:input_type -> builder.BuildRequest
	13, // 19: builder.ImageBuilder.Logs:input_type -> builder.LogsRequest
	15, // 20: builder.ImageBuilder.ListBuilds:input_type -> builder.ListBuildsRequest
	5,  // 21: builder.ImageBuilder.ResolveBaseImage:output_type -> builder.ResolveBaseImageResponse
	7,  // 22: builder.ImageBuilder.ResolveWorkspaceImage:output_type -> builder.ResolveWorkspaceImageResponse
	12, // 23: builder.ImageBuilder.Build:output_type -> builder.BuildResponse
	14, // 24: builder.ImageBuilder.Logs:output_type -> builder.LogsResponse
	16, // 25: builder.ImageBuilder.ListBuilds:output_type -> builder.ListBuildsResponse
